...
<li class="active"><a href="hrloginpage.jsp"><h4>HR MODULE</h4></a></li>
<li><a href="employeepage.jsp"><h4>EMPLOYEE MODULE</h4></a></li>
<li><a href="contact.jsp"><h4>CONTACT US</h4></li>
</ul>

<ul class="nav navbar-primary navbar-right">
